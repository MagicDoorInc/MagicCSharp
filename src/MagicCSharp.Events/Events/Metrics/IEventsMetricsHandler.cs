...
namespace MagicCSharp.Events.Metrics;
...
public class EventsMetricsHandler(IMeterFactory meterFactory) : IEventsMetricsHandler
{
    ...
    private readonly Counter<int> eventFailedCounter = meterFactory.Create("MagicCSharp.Events").CreateCounter<int>("Events.Failed");
    private readonly Counter<int> eventFinishedCounter = meterFactory.Create("MagicCSharp.Events").CreateCounter<int>("Events.Finished");
    private readonly Counter<int> gotEventCounter = meterFactory.Create("MagicCSharp.Events").CreateCounter<int>("Events");
    private readonly Histogram<double> executionTimeHistogram = meterFactory.Create("MagicCSharp.Events").CreateHistogram<double>("Events.ExecutionTime");
